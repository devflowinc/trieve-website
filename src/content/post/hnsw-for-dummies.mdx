...
image: /public/embedding-space.webp
...
As vector search problems scale to the tune of millions and even billions of vectors, there comes a big question challenge that comes into question. How can we optimize our indexes for space and/or time. The question that [qdrant.tech](https://qdrant.tech), [vespa.ai](https://vespa.ai) and many other vector search engines tell you to do is to tune the HNSW index.

These are the parameters we will talk about.
...
⚠ ⚠ ⚠ **For the speedrunners. We start from the basics and expand out. Skip as needed**⚠ ⚠ ⚠
...
![Animated graphic showing HNSW graph traversal](/public/HNSWSingle.gif)
...
![Graphic showing layered HNSW graph](/public/hnsw-paper-graphic.png)


## Index building

Oh cool... wait, whats this `ef_construct` parameter used for? Well the vespa alternative name explains it much cleaner than the papers name. Its the nubmer of neighbors to expolore at insert. Lets talk a little bit about indexing.
...
![Filter HNSW graphic](/public/filter-hnsw.png)
...
![Filter HNSW problems](/public/filter-hnsw-problems.png)
...
![Filter HNSW problems](/public/filter-hnsw-subgraph.png)
...
`ef_construct` is how many nodes to look at when attempting to determine its neighbors.
