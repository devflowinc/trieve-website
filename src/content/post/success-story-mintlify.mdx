---
publishDate: 2024-09-02T22:10:00Z
...
import Quote from '/Users/fedect/git_projects/trieve-website/src/components/common/BigQuote.astro';

## About BillTrack50

BillTrack50 is a search engine for democracy. An innovator, BillTrack50 is the OS for the nation’s top lobbies, advocacy groups, and government affairs departments. A competitive space, the BillTrack50 development team works hard to enable advantages and leverage to their customers, at scale. 
...
With most of the support being done over email, it took the team one sprint to build, test, evaluate the Trieve-based solution against others, and deploy it to a smaller group of customers. After a successful trial period, it was immediately well-recieved 


## Problem: I didn't know what to search

We are grateful to the BillTrack50 team and their users for informing critical development and hitting our service with frequency.

Search, recommendations, and RAG share fundamental mechanics. Trieve is the API and the team to get your features built, shipped, and deployed at scale for intense usage. If this is you, book a call here.
